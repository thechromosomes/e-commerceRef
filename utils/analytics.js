export default class GoogleAnalytics {
  ...
  recordProductViewedEvent(itemName) {
    if (this.env === "prod") {
      ...
      console.log(
        `Tracker Type: ${this.tracker} & Product Viewed: ${itemName}`
      );
    }
  }
  ...
  recordFilterEvent(pos, filter) {
    if (this.env === "prod") {
      ...
      console.log(
        `Tracker Type: ${this.tracker} &  ${pos} Filter Recorded: ${filter}`
      );
    }
  }
  ...
  recordCartEvent(itemName) {
    if (this.env === "prod") {
          ...
          case "ga":
            {
              ga(
                "send",
                "event",
                "Product Added in the Cart via SearchTap",
                "click",
                itemName
              );
            }
      ...
      console.log(
        `Tracker Type: ${this.tracker} & Add to Cart Event Recorded for: ${itemName}`
      );
    }
  }
  ...
  recordWishListEvent(itemName) {
    if (this.env === "prod") {
      ...
      console.log(
        `Tracker Type: ${this.tracker} & Add to WishList Event Recorded for: ${itemName}`
      );
    }
  }
}
